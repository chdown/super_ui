  ...
  Widget build(BuildContext context) {
    ...
    return TextField(
      ...
      decoration: InputDecoration(
        ...
        prefixIconConstraints: widget.prefixIconConstraints ?? const BoxConstraints(maxWidth: 32),
        ...
        suffixIconConstraints: widget.suffixIconConstraints ?? const BoxConstraints(maxWidth: 32),
